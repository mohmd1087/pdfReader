...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://16.170.252.150/admin/active_users', {
        ...
        // Fetch all users
        axios.get('http://16.170.252.150/admin/users', {
            headers: { 'Authorization': `Bearer ${localStorage.getItem('jwtToken')}` }
        })
    ...
    const handleUserClick = (userId) => {
        ...
        axios.get('http://16.170.252.150/admin/pdfs', {
            headers: { 'Authorization': `Bearer ${localStorage.getItem('jwtToken')}` }
        })
    ...
    const handlePdfClick = (pdfId) => {
        ...
        axios.get(`http://16.170.252.150/admin/pdf_chats/${pdfId}`, {
            headers: { 'Authorization': `Bearer ${localStorage.getItem('jwtToken')}` }
        })
